...
for x in range(2):
    ...
    for _ in range(2):
        ...
        field1 = Generator.Blur(field1, blur_type=Generator.BlurClass.standart3x3, target_values=[1], iterations=1)
        field1 = Generator.ReplaceCells(field1, replace=[1, 2], to=[7, 8, 9], p=0.05)
        field1 = Generator.Blur(field1, blur_type=Generator.BlurClass.standart5x5, iterations=1)
...
field3 = Generator.AverageAmountOfFields(*fields)


'''Сохранение результата'''

Generator.SaveImage(field3, directory + f"picture3.png", [x for x in reversed(Generator.GradientClass.black_orange_yellow_white)])
